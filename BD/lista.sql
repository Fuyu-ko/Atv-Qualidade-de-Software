...
INSERT INTO `lista`.`itemcheck` (`idItem`, `pergunta`, `checkagem`, `item`, `obs`, `idCheck`) VALUES ('15', 'O artefato apresenta um mecanismo de marcação de conteúdos confidenciais?', 'Não se aplica', 'Segurança', 'Não há', '2');
