...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        ...
        <div class="w3-code cssHigh notranslate">
            ...
            $sql = "SELECT idAvaliacao, idAuditoriaC, pergunta, checkagem, item, obs FROM checklist";
            ...
            if ($result = mysqli_query($conn, $sql)) {
                ...
                echo "    <th width='20%'>Item Avaliado</th>";
                echo "    <th width='25%'>Pergunta</th>";
                echo "    <th width='10%'>Check</th>";
                echo "    <th width='10%'>NC</th>";
                echo "    <th width='10%'>AC</th>";
                echo "    <th width='10%'>OBS</th>";
                echo "    <th width='10%'> </th>";
                echo "    <th width='10%'> </th>";
                echo "  </tr>";
